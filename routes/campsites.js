...
// edit campsite route
router.get('/campsites/:id/edit', checkCampsiteOwnership, function(req, res) {
...
router.put('/campsites/:id', checkCampsiteOwnership, function(req, res) {
...
router.delete('/campsites/:id', checkCampsiteOwnership, function(req, res) {
